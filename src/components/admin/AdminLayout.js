...
const sidebarItems = [
  ...
  { label: 'Content', items: [
    ...
    { label: 'School News', href: '/admin/school-news', icon: 'fas fa-school' },
  ...
  { label: 'Documents', items: [
    ...
    { label: 'Comprehensive Information', href: '/admin/comprehensive-information', icon: 'fas fa-file-alt' },
    { label: 'Question Bank', href: '/admin/question-bank', icon: 'fas fa-folder-open' },
  ]},
];
