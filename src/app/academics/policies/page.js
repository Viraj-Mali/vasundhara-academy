...
const policies = [
  ...
  { icon: 'fas fa-shield-alt', title: 'Safety & Security', items: ['CCTV surveillance across campus', 'Authorized pickup only for students', 'Fire safety equipment and regular drills', 'Visitor registration mandatory at reception'] },
